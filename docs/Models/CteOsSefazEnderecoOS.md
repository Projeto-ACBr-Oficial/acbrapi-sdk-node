...
| **CEP** | **string** | CEP.  Informar os zeros não significativos. | [opcional]  |
| **UF** | **string** | Sigla da UF.  Informar EX para operações com o exterior. |  |
| **cPais** | **string** | Código do país.  Utilizar a tabela do BACEN. | [opcional]  |
| **xPais** | **string** | Nome do país. | [opcional]  |
