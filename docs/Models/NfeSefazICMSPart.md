...
| **pBCOp** | **number** | Percentual para determinação do valor  da Base de Cálculo da operação própria. |  |
| **UFST** | **string** | Sigla da UF para qual é devido o ICMS ST da operação. |  |
| **vICMSDeson** | **number** | Valor do ICMS de desoneração. | [opcional]  |
| **motDesICMS** | **number** | Motivo da desoneração do ICMS:9-Outros;10&#x3D;Deficiente Condutor (Convênio ICMS 38/12) 11&#x3D;Deficiente Não Condutor (Convênio ICMS 38/12). | [opcional]  |
