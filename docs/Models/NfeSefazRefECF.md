...
| **nECF** | **number** | Informar o número de ordem seqüencial do ECF que emitiu o Cupom Fiscal vinculado à NF-e. |  |
| **nCOO** | **number** | Informar o Número do Contador de Ordem de Operação - COO vinculado à NF-e. |  |
