...
|------------ | ------------- | ------------- | -------------|
| **id** | **string** | ID único gerado pela API para este documento. | [opcional]  |
...
| **data\_emissao** | **Date** |  | [opcional]  |
| **modelo** | **number** |  | [opcional]  |
| **serie** | **number** |  | [opcional]  |
| **numero** | **number** |  | [opcional]  |
| **tipo\_emissao** | **number** |  | [opcional]  |
| **valor\_total** | **number** |  | [opcional]  |
