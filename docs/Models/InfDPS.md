...
| **serie** | **string** | Número do equipamento emissor do DPS ou série do DPS.    Informar apenas quando a numeracao automatica estiver desabilitada na configuracao da empresa. | [opcional]  |
| **nDPS** | **string** | Número do DPS.    Informar apenas quando a numeracao automatica estiver desabilitada na configuracao da empresa. | [opcional]  |
