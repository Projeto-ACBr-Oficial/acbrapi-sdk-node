...
| **qBCMono** | **number** | Quantidade tributada. | [opcional]  |
| **adRemICMS** | **number** | Alíquota ad rem do imposto. |  |
| **vICMSMono** | **number** | Valor do ICMS próprio. |  |
| **qBCMonoReten** | **number** | Quantidade tributada sujeita a retenção. | [opcional]  |
| **adRemICMSReten** | **number** | Alíquota ad rem do imposto com retenção. |  |
| **vICMSMonoReten** | **number** | Valor do ICMS com retenção. |  |
| **pRedAdRem** | **number** | Percentual de redução do valor da alíquota ad rem do ICMS. | [opcional]  |
| **motRedAdRem** | **number** | Motivo da redução do adrem  * 1 - Transporte coletivo de passageiros  * 9 - Outros | [opcional]  |
