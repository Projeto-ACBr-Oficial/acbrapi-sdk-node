...
|------------ | ------------- | ------------- | -------------|
| **tpOp** | **number** | Tipo da Operação (1 - Venda concessionária; 2 - Faturamento direto; 3 - Venda direta; 0 - Outros). |  |
...
| **anoMod** | **number** | Ano Modelo de Fabricação. |  |
| **anoFab** | **number** | Ano de Fabricação. |  |
| **tpPint** | **string** | Tipo de pintura. |  |
| **tpVeic** | **number** | Tipo de veículo (utilizar tabela RENAVAM). |  |
| **espVeic** | **number** | Espécie de veículo (utilizar tabela RENAVAM). |  |
| **VIN** | **string** | Informa-se o veículo tem VIN (chassi) remarcado.  * R-Remarcado  * N-NormalVIN |  |
| **condVeic** | **number** | Condição do veículo (1 - acabado; 2 - inacabado; 3 - semi-acabado). |  |
...
| **lota** | **number** | Quantidade máxima de permitida de passageiros sentados, inclusive motorista. |  |
| **tpRest** | **number** | Restrição  * 0 - Não há  * 1 - Alienação Fiduciária  * 2 - Arrendamento Mercantil  * 3 - Reserva de Domínio  * 4 - Penhor de Veículos  * 9 - outras |  |
