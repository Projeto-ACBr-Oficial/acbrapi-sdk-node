...
|------------ | ------------- | ------------- | -------------|
| **tpUnidTransp** | **number** | Tipo da Unidade de Transporte.  * 1 - Rodoviário Tração  * 2 - Rodoviário Reboque  * 3 - Navio  * 4 - Balsa  * 5 - Aeronave  * 6 - Vagão  * 7 - Outros |  |
...
| **lacUnidTransp** | [**Array**](CteSefazLacUnidTransp.md) |  | [opcional]  |
| **infUnidCarga** | [**Array**](CteSefazUnidCarga.md) |  | [opcional]  |
| **qtdRat** | **number** | Quantidade rateada (Peso,Volume). | [opcional]  |
