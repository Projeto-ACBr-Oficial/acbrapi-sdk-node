...
| **adRemICMS** | **number** | Alíquota ad rem do imposto. | [opcional]  |
| **vICMSMonoOp** | **number** | Valor do ICMS da operação. | [opcional]  |
| **pDif** | **number** | Percentual do diferemento. | [opcional]  |
| **vICMSMonoDif** | **number** | Valor do ICMS diferido. | [opcional]  |
| **vICMSMono** | **number** | Valor do ICMS próprio devido. | [opcional]  |
| **qBCMonoDif** | **number** | Quantidade tributada diferida.  OBS: Campo revogado pela NT2023.001v1.20 | [opcional]  |
| **adRemICMSDif** | **number** | Alíquota ad rem do imposto diferido.  OBS: Campo revogado pela NT2023.001v1.20 | [opcional]  |
