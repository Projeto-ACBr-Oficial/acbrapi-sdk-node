...
| **qBCMonoRet** | **number** | Quantidade tributada retida anteriormente. | [opcional]  |
| **adRemICMSRet** | **number** | Alíquota ad rem do imposto retido anteriormente. |  |
| **vICMSMonoRet** | **number** | Valor do ICMS retido anteriormente. |  |
