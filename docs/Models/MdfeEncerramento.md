...
|------------ | ------------- | ------------- | -------------|
| **data\_encerramento** | **Date** | Data que o manifesto foi encerrado. | [opcional]  |
| **uf** | **string** | UF de encerramento do manifesto. | [opcional]  |
| **codigo\_municipio** | **string** | Código do Município de encerramento do manifesto. | [opcional]  |
