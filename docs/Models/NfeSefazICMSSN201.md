...
| **modBCST** | **number** | Modalidade de determinação da BC do ICMS ST:  * 0 - Preço tabelado ou máximo  sugerido  * 1 - Lista Negativa (valor)  * 2 - Lista Positiva (valor)  * 3 - Lista Neutra (valor)  * 4 - Margem Valor Agregado (%%)  * 5 - Pauta (valor). (v2.0)  * 6 - Valor da Operação |  |
| **pMVAST** | **number** | Percentual da Margem de Valor Adicionado ICMS ST (v2.0). | [opcional]  |
| **pRedBCST** | **number** | Percentual de redução da BC ICMS ST  (v2.0). | [opcional]  |
| **vBCST** | **number** | Valor da BC do ICMS ST (v2.0). |  |
| **pICMSST** | **number** | Alíquota do ICMS ST (v2.0). |  |
| **vICMSST** | **number** | Valor do ICMS ST (v2.0). |  |
...
| **pCredSN** | **number** | Alíquota aplicável de cálculo do crédito (Simples Nacional). (v2.0). |  |
| **vCredICMSSN** | **number** | Valor crédito do ICMS que pode ser aproveitado nos termos do art. 23 da LC 123 (Simples Nacional) (v2.0). |  |
