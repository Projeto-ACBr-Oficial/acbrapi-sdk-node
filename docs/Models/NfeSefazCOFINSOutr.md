...
| **vBC** | **number** | Valor da BC do COFINS. | [opcional]  |
| **pCOFINS** | **number** | Alíquota do COFINS (em percentual). | [opcional]  |
| **qBCProd** | **number** | Quantidade Vendida (NT2011/004). | [opcional]  |
| **vAliqProd** | **number** | Alíquota do COFINS (em reais) (NT2011/004). | [opcional]  |
