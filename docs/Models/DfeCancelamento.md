...
|------------ | ------------- | ------------- | -------------|
| **justificativa** | **string** | Justificativa do cancelamento. | [opcional]  |
| **chave\_substituta** | **string** | Chave de acesso da NFC-e substituta. Preenchida apenas no cancelamento  por substituição (evento 110112). | [opcional]  |
