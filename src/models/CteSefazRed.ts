...
/**
 * Check if a given object implements the CteSefazRed interface.
 */
export function instanceOfCteSefazRed(value: object): boolean {
    let isInstance = true;
...
export function CteSefazRedFromJSON(json: any): CteSefazRed {
    return CteSefazRedFromJSONTyped(json, false);
}

export function CteSefazRedFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazRed {
...
export function CteSefazRedToJSON(value?: CteSefazRed | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
