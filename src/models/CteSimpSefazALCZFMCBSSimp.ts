 ...
 * @export
 * @interface CteSimpSefazALCZFMCBSSimp
 */
export interface CteSimpSefazALCZFMCBSSimp {
    /**
     ...
     * @type {number}
     * @memberof CteSimpSefazALCZFMCBSSimp
     */
...
/**
 * Check if a given object implements the CteSimpSefazALCZFMCBSSimp interface.
 */
export function instanceOfCteSimpSefazALCZFMCBSSimp(value: object): boolean {
    let isInstance = true;
...
export function CteSimpSefazALCZFMCBSSimpFromJSON(json: any): CteSimpSefazALCZFMCBSSimp {
    return CteSimpSefazALCZFMCBSSimpFromJSONTyped(json, false);
}

export function CteSimpSefazALCZFMCBSSimpFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSimpSefazALCZFMCBSSimp {
...
export function CteSimpSefazALCZFMCBSSimpToJSON(value?: CteSimpSefazALCZFMCBSSimp | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
