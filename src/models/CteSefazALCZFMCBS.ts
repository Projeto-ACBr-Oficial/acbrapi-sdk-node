 ...
 * @export
 * @interface CteSefazALCZFMCBS
 */
export interface CteSefazALCZFMCBS {
    /**
...
/**
 * Check if a given object implements the CteSefazALCZFMCBS interface.
 */
export function instanceOfCteSefazALCZFMCBS(value: object): boolean {
    let isInstance = true;
...
export function CteSefazALCZFMCBSFromJSON(json: any): CteSefazALCZFMCBS {
    return CteSefazALCZFMCBSFromJSONTyped(json, false);
}

export function CteSefazALCZFMCBSFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazALCZFMCBS {
...
export function CteSefazALCZFMCBSToJSON(value?: CteSefazALCZFMCBS | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
