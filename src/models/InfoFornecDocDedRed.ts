 ...
 * @export
 * @interface InfoFornecDocDedRed
 */
export interface InfoFornecDocDedRed {
    /**
     * Número do CNPJ.
     * @type {string}
     * @memberof InfoFornecDocDedRed
     */
    CNPJ?: string | null;
    /**
     * Número do CPF.
...
/**
 * Check if a given object implements the InfoFornecDocDedRed interface.
 */
export function instanceOfInfoFornecDocDedRed(value: object): boolean {
    let isInstance = true;
...
export function InfoFornecDocDedRedFromJSON(json: any): InfoFornecDocDedRed {
    return InfoFornecDocDedRedFromJSONTyped(json, false);
}

export function InfoFornecDocDedRedFromJSONTyped(json: any, ignoreDiscriminator: boolean): InfoFornecDocDedRed {
...
export function InfoFornecDocDedRedToJSON(value?: InfoFornecDocDedRed | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
