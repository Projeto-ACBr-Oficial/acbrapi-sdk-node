...
/**
 * Check if a given object implements the NfcomSefazRed interface.
 */
export function instanceOfNfcomSefazRed(value: object): boolean {
    let isInstance = true;
...
export function NfcomSefazRedFromJSON(json: any): NfcomSefazRed {
    return NfcomSefazRedFromJSONTyped(json, false);
}

export function NfcomSefazRedFromJSONTyped(json: any, ignoreDiscriminator: boolean): NfcomSefazRed {
...
export function NfcomSefazRedToJSON(value?: NfcomSefazRed | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
