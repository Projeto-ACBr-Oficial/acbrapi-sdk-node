...
/**
 * Check if a given object implements the CteOsSefazICMSUFFimOS interface.
 */
export function instanceOfCteOsSefazICMSUFFimOS(value: object): boolean {
    let isInstance = true;
...
export function CteOsSefazICMSUFFimOSFromJSON(json: any): CteOsSefazICMSUFFimOS {
    return CteOsSefazICMSUFFimOSFromJSONTyped(json, false);
}

export function CteOsSefazICMSUFFimOSFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteOsSefazICMSUFFimOS {
...
export function CteOsSefazICMSUFFimOSToJSON(value?: CteOsSefazICMSUFFimOS | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
