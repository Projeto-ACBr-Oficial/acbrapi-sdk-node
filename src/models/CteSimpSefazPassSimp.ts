 ...
 * 
 * @export
 * @interface CteSimpSefazPassSimp
 */
export interface CteSimpSefazPassSimp {
     ...
     * @type {string}
     * @memberof CteSimpSefazPassSimp
     */
    xPass?: string | null;
}

/**
 * Check if a given object implements the CteSimpSefazPassSimp interface.
 */
export function instanceOfCteSimpSefazPassSimp(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CteSimpSefazPassSimpFromJSON(json: any): CteSimpSefazPassSimp {
    return CteSimpSefazPassSimpFromJSONTyped(json, false);
}

export function CteSimpSefazPassSimpFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSimpSefazPassSimp {
...
export function CteSimpSefazPassSimpToJSON(value?: CteSimpSefazPassSimp | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
