...
/**
 * Check if a given object implements the CteOsSefazRedOS interface.
 */
export function instanceOfCteOsSefazRedOS(value: object): boolean {
    let isInstance = true;
...
export function CteOsSefazRedOSFromJSON(json: any): CteOsSefazRedOS {
    return CteOsSefazRedOSFromJSONTyped(json, false);
}

export function CteOsSefazRedOSFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteOsSefazRedOS {
...
export function CteOsSefazRedOSToJSON(value?: CteOsSefazRedOS | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
