 ...
 * @export
 * @interface MdfeSefazLacres
 */
export interface MdfeSefazLacres {
    /**
     * número do lacre.
     * @type {string}
     * @memberof MdfeSefazLacres
     */
    nLacre: string | null;
}

/**
 * Check if a given object implements the MdfeSefazLacres interface.
 */
export function instanceOfMdfeSefazLacres(value: object): boolean {
    let isInstance = true;
...
export function MdfeSefazLacresFromJSON(json: any): MdfeSefazLacres {
    return MdfeSefazLacresFromJSONTyped(json, false);
}

export function MdfeSefazLacresFromJSONTyped(json: any, ignoreDiscriminator: boolean): MdfeSefazLacres {
...
export function MdfeSefazLacresToJSON(value?: MdfeSefazLacres | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
