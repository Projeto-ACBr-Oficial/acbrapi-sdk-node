 ...
 * @export
 * @interface CteSimpSefazRespTecSimp
 */
export interface CteSimpSefazRespTecSimp {
     ...
     * @type {string}
     * @memberof CteSimpSefazRespTecSimp
     */
    CNPJ: string | null;
    /**
...
/**
 * Check if a given object implements the CteSimpSefazRespTecSimp interface.
 */
export function instanceOfCteSimpSefazRespTecSimp(value: object): boolean {
    let isInstance = true;
...
export function CteSimpSefazRespTecSimpFromJSON(json: any): CteSimpSefazRespTecSimp {
    return CteSimpSefazRespTecSimpFromJSONTyped(json, false);
}

export function CteSimpSefazRespTecSimpFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSimpSefazRespTecSimp {
...
export function CteSimpSefazRespTecSimpToJSON(value?: CteSimpSefazRespTecSimp | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
