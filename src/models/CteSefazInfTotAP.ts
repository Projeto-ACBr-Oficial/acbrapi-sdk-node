...
/**
 * Check if a given object implements the CteSefazInfTotAP interface.
 */
export function instanceOfCteSefazInfTotAP(value: object): boolean {
    let isInstance = true;
...
export function CteSefazInfTotAPFromJSON(json: any): CteSefazInfTotAP {
    return CteSefazInfTotAPFromJSONTyped(json, false);
}

export function CteSefazInfTotAPFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazInfTotAP {
...
export function CteSefazInfTotAPToJSON(value?: CteSefazInfTotAP | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
