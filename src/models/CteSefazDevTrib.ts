...
/**
 * Check if a given object implements the CteSefazDevTrib interface.
 */
export function instanceOfCteSefazDevTrib(value: object): boolean {
    let isInstance = true;
...
export function CteSefazDevTribFromJSON(json: any): CteSefazDevTrib {
    return CteSefazDevTribFromJSONTyped(json, false);
}

export function CteSefazDevTribFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazDevTrib {
...
export function CteSefazDevTribToJSON(value?: CteSefazDevTrib | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
