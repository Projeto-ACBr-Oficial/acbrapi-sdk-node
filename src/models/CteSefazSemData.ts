...
export interface CteSefazSemData {
     ...
     * * 0 - Sem data definida
     * @type {number}
     * @memberof CteSefazSemData
     */
    tpPer: number | null;
}

/**
 * Check if a given object implements the CteSefazSemData interface.
 */
export function instanceOfCteSefazSemData(value: object): boolean {
    let isInstance = true;
...
export function CteSefazSemDataFromJSON(json: any): CteSefazSemData {
    return CteSefazSemDataFromJSONTyped(json, false);
}

export function CteSefazSemDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazSemData {
...
export function CteSefazSemDataToJSON(value?: CteSefazSemData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
