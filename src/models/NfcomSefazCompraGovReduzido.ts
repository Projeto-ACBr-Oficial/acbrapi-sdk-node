 ...
 * @export
 * @interface NfcomSefazCompraGovReduzido
 */
export interface NfcomSefazCompraGovReduzido {
     ...
     * @type {number}
     * @memberof NfcomSefazCompraGovReduzido
     */
...
/**
 * Check if a given object implements the NfcomSefazCompraGovReduzido interface.
 */
export function instanceOfNfcomSefazCompraGovReduzido(value: object): boolean {
    let isInstance = true;
...
export function NfcomSefazCompraGovReduzidoFromJSON(json: any): NfcomSefazCompraGovReduzido {
    return NfcomSefazCompraGovReduzidoFromJSONTyped(json, false);
}

export function NfcomSefazCompraGovReduzidoFromJSONTyped(json: any, ignoreDiscriminator: boolean): NfcomSefazCompraGovReduzido {
...
export function NfcomSefazCompraGovReduzidoToJSON(value?: NfcomSefazCompraGovReduzido | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
