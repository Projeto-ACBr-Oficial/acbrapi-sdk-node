...
/**
 * Check if a given object implements the NfcomSefazAutXML interface.
 */
export function instanceOfNfcomSefazAutXML(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function NfcomSefazAutXMLFromJSON(json: any): NfcomSefazAutXML {
    return NfcomSefazAutXMLFromJSONTyped(json, false);
}

export function NfcomSefazAutXMLFromJSONTyped(json: any, ignoreDiscriminator: boolean): NfcomSefazAutXML {
...
export function NfcomSefazAutXMLToJSON(value?: NfcomSefazAutXML | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
