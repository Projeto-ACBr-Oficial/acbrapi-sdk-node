 ...
 * @export
 * @interface CteSimpSefazAutXMLSimp
 */
export interface CteSimpSefazAutXMLSimp {
     ...
     * @type {string}
     * @memberof CteSimpSefazAutXMLSimp
     */
    CNPJ?: string | null;
    /**
     * CPF do autorizado.
...
/**
 * Check if a given object implements the CteSimpSefazAutXMLSimp interface.
 */
export function instanceOfCteSimpSefazAutXMLSimp(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CteSimpSefazAutXMLSimpFromJSON(json: any): CteSimpSefazAutXMLSimp {
    return CteSimpSefazAutXMLSimpFromJSONTyped(json, false);
}

export function CteSimpSefazAutXMLSimpFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSimpSefazAutXMLSimp {
...
export function CteSimpSefazAutXMLSimpToJSON(value?: CteSimpSefazAutXMLSimp | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
