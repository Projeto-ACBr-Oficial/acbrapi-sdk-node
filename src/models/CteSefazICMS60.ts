...
/**
 * Check if a given object implements the CteSefazICMS60 interface.
 */
export function instanceOfCteSefazICMS60(value: object): boolean {
    let isInstance = true;
...
export function CteSefazICMS60FromJSON(json: any): CteSefazICMS60 {
    return CteSefazICMS60FromJSONTyped(json, false);
}

export function CteSefazICMS60FromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazICMS60 {
...
export function CteSefazICMS60ToJSON(value?: CteSefazICMS60 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
