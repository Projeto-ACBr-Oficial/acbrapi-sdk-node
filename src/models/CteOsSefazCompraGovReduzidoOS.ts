 ...
 * @export
 * @interface CteOsSefazCompraGovReduzidoOS
 */
export interface CteOsSefazCompraGovReduzidoOS {
     ...
     * @type {number}
     * @memberof CteOsSefazCompraGovReduzidoOS
     */
...
/**
 * Check if a given object implements the CteOsSefazCompraGovReduzidoOS interface.
 */
export function instanceOfCteOsSefazCompraGovReduzidoOS(value: object): boolean {
    let isInstance = true;
...
export function CteOsSefazCompraGovReduzidoOSFromJSON(json: any): CteOsSefazCompraGovReduzidoOS {
    return CteOsSefazCompraGovReduzidoOSFromJSONTyped(json, false);
}

export function CteOsSefazCompraGovReduzidoOSFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteOsSefazCompraGovReduzidoOS {
...
export function CteOsSefazCompraGovReduzidoOSToJSON(value?: CteOsSefazCompraGovReduzidoOS | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
