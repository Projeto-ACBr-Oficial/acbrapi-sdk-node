...
/**
 * Check if a given object implements the CteSefazRespTec interface.
 */
export function instanceOfCteSefazRespTec(value: object): boolean {
    let isInstance = true;
...
export function CteSefazRespTecFromJSON(json: any): CteSefazRespTec {
    return CteSefazRespTecFromJSONTyped(json, false);
}

export function CteSefazRespTecFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazRespTec {
...
export function CteSefazRespTecToJSON(value?: CteSefazRespTec | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
