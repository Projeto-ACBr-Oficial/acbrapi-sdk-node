 ...
 * @export
 * @interface MdfeSefazInfSolicNFF
 */
export interface MdfeSefazInfSolicNFF {
     ...
     * @type {string}
     * @memberof MdfeSefazInfSolicNFF
     */
    xSolic: string | null;
}

/**
 * Check if a given object implements the MdfeSefazInfSolicNFF interface.
 */
export function instanceOfMdfeSefazInfSolicNFF(value: object): boolean {
    let isInstance = true;
...
export function MdfeSefazInfSolicNFFFromJSON(json: any): MdfeSefazInfSolicNFF {
    return MdfeSefazInfSolicNFFFromJSONTyped(json, false);
}

export function MdfeSefazInfSolicNFFFromJSONTyped(json: any, ignoreDiscriminator: boolean): MdfeSefazInfSolicNFF {
...
export function MdfeSefazInfSolicNFFToJSON(value?: MdfeSefazInfSolicNFF | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
