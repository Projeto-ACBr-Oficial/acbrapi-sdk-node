...
/**
 * Check if a given object implements the CteOsSefazRespTecOS interface.
 */
export function instanceOfCteOsSefazRespTecOS(value: object): boolean {
    let isInstance = true;
...
export function CteOsSefazRespTecOSFromJSON(json: any): CteOsSefazRespTecOS {
    return CteOsSefazRespTecOSFromJSONTyped(json, false);
}

export function CteOsSefazRespTecOSFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteOsSefazRespTecOS {
...
export function CteOsSefazRespTecOSToJSON(value?: CteOsSefazRespTecOS | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
