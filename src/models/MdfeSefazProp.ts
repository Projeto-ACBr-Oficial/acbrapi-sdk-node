...
/**
 * Check if a given object implements the MdfeSefazProp interface.
 */
export function instanceOfMdfeSefazProp(value: object): boolean {
    let isInstance = true;
...
export function MdfeSefazPropFromJSON(json: any): MdfeSefazProp {
    return MdfeSefazPropFromJSONTyped(json, false);
}

export function MdfeSefazPropFromJSONTyped(json: any, ignoreDiscriminator: boolean): MdfeSefazProp {
...
export function MdfeSefazPropToJSON(value?: MdfeSefazProp | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
