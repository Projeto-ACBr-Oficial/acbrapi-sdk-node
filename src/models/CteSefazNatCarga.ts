...
/**
 * Check if a given object implements the CteSefazNatCarga interface.
 */
export function instanceOfCteSefazNatCarga(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CteSefazNatCargaFromJSON(json: any): CteSefazNatCarga {
    return CteSefazNatCargaFromJSONTyped(json, false);
}

export function CteSefazNatCargaFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazNatCarga {
...
export function CteSefazNatCargaToJSON(value?: CteSefazNatCarga | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
