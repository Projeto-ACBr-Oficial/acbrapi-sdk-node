...
/**
 * Check if a given object implements the RTCListaDocOutro interface.
 */
export function instanceOfRTCListaDocOutro(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "nDoc" in value;
    isInstance = isInstance && "xDoc" in value;

    return isInstance;
}

export function RTCListaDocOutroFromJSON(json: any): RTCListaDocOutro {
    return RTCListaDocOutroFromJSONTyped(json, false);
}

export function RTCListaDocOutroFromJSONTyped(json: any, ignoreDiscriminator: boolean): RTCListaDocOutro {
...
export function RTCListaDocOutroToJSON(value?: RTCListaDocOutro | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
