...
export interface CteSefazInfSolicNFF {
     ...
     * @type {string}
     * @memberof CteSefazInfSolicNFF
     */
    xSolic: string | null;
}

/**
 * Check if a given object implements the CteSefazInfSolicNFF interface.
 */
export function instanceOfCteSefazInfSolicNFF(value: object): boolean {
    let isInstance = true;
...
export function CteSefazInfSolicNFFFromJSON(json: any): CteSefazInfSolicNFF {
    return CteSefazInfSolicNFFFromJSONTyped(json, false);
}

export function CteSefazInfSolicNFFFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazInfSolicNFF {
...
export function CteSefazInfSolicNFFToJSON(value?: CteSefazInfSolicNFF | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
