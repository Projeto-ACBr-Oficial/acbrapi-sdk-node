 ...
 * @export
 * @interface NfcomSefazGCofatGNF
 */
export interface NfcomSefazGCofatGNF {
    /**
     * CNPJ do Emitente.
     * Informar o CNPJ do emitente do Documento Fiscal.
     * @type {string}
     * @memberof NfcomSefazGCofatGNF
     */
    CNPJ: string | null;
    /**
     * Modelo do documento.
...
/**
 * Check if a given object implements the NfcomSefazGCofatGNF interface.
 */
export function instanceOfNfcomSefazGCofatGNF(value: object): boolean {
    let isInstance = true;
...
export function NfcomSefazGCofatGNFFromJSON(json: any): NfcomSefazGCofatGNF {
    return NfcomSefazGCofatGNFFromJSONTyped(json, false);
}

export function NfcomSefazGCofatGNFFromJSONTyped(json: any, ignoreDiscriminator: boolean): NfcomSefazGCofatGNF {
...
export function NfcomSefazGCofatGNFToJSON(value?: NfcomSefazGCofatGNF | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
