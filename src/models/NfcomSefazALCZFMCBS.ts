 ...
 * @export
 * @interface NfcomSefazALCZFMCBS
 */
export interface NfcomSefazALCZFMCBS {
    /**
...
/**
 * Check if a given object implements the NfcomSefazALCZFMCBS interface.
 */
export function instanceOfNfcomSefazALCZFMCBS(value: object): boolean {
    let isInstance = true;
...
export function NfcomSefazALCZFMCBSFromJSON(json: any): NfcomSefazALCZFMCBS {
    return NfcomSefazALCZFMCBSFromJSONTyped(json, false);
}

export function NfcomSefazALCZFMCBSFromJSONTyped(json: any, ignoreDiscriminator: boolean): NfcomSefazALCZFMCBS {
...
export function NfcomSefazALCZFMCBSToJSON(value?: NfcomSefazALCZFMCBS | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
