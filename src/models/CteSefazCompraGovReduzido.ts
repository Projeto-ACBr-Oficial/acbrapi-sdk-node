 ...
 * @export
 * @interface CteSefazCompraGovReduzido
 */
export interface CteSefazCompraGovReduzido {
     ...
     * @type {number}
     * @memberof CteSefazCompraGovReduzido
     */
...
/**
 * Check if a given object implements the CteSefazCompraGovReduzido interface.
 */
export function instanceOfCteSefazCompraGovReduzido(value: object): boolean {
    let isInstance = true;
...
export function CteSefazCompraGovReduzidoFromJSON(json: any): CteSefazCompraGovReduzido {
    return CteSefazCompraGovReduzidoFromJSONTyped(json, false);
}

export function CteSefazCompraGovReduzidoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazCompraGovReduzido {
...
export function CteSefazCompraGovReduzidoToJSON(value?: CteSefazCompraGovReduzido | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
