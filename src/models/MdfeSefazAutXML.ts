...
/**
 * Check if a given object implements the MdfeSefazAutXML interface.
 */
export function instanceOfMdfeSefazAutXML(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function MdfeSefazAutXMLFromJSON(json: any): MdfeSefazAutXML {
    return MdfeSefazAutXMLFromJSONTyped(json, false);
}

export function MdfeSefazAutXMLFromJSONTyped(json: any, ignoreDiscriminator: boolean): MdfeSefazAutXML {
...
export function MdfeSefazAutXMLToJSON(value?: MdfeSefazAutXML | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
