 ...
 * @export
 * @interface CteSefazLacre
 */
export interface CteSefazLacre {
    /**
     * Lacre.
     * @type {string}
     * @memberof CteSefazLacre
     */
    nLacre: string | null;
}

/**
 * Check if a given object implements the CteSefazLacre interface.
 */
export function instanceOfCteSefazLacre(value: object): boolean {
    let isInstance = true;
...
export function CteSefazLacreFromJSON(json: any): CteSefazLacre {
    return CteSefazLacreFromJSONTyped(json, false);
}

export function CteSefazLacreFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazLacre {
...
export function CteSefazLacreToJSON(value?: CteSefazLacre | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
