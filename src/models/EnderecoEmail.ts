 ...
 * 
 * @export
 * @interface EnderecoEmail
 */
export interface EnderecoEmail {
    /**
     * Email do destinatário.
     * @type {string}
     * @memberof EnderecoEmail
     */
    email: string;
}

/**
 * Check if a given object implements the EnderecoEmail interface.
 */
export function instanceOfEnderecoEmail(value: object): boolean {
    let isInstance = true;
...
export function EnderecoEmailFromJSON(json: any): EnderecoEmail {
    return EnderecoEmailFromJSONTyped(json, false);
}

export function EnderecoEmailFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnderecoEmail {
...
export function EnderecoEmailToJSON(value?: EnderecoEmail | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
