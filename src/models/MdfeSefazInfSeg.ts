 ...
 * @export
 * @interface MdfeSefazInfSeg
 */
export interface MdfeSefazInfSeg {
    /**
     * Nome da Seguradora.
     * @type {string}
     * @memberof MdfeSefazInfSeg
     */
    xSeg: string | null;
    /**
...
/**
 * Check if a given object implements the MdfeSefazInfSeg interface.
 */
export function instanceOfMdfeSefazInfSeg(value: object): boolean {
    let isInstance = true;
...
export function MdfeSefazInfSegFromJSON(json: any): MdfeSefazInfSeg {
    return MdfeSefazInfSegFromJSONTyped(json, false);
}

export function MdfeSefazInfSegFromJSONTyped(json: any, ignoreDiscriminator: boolean): MdfeSefazInfSeg {
...
export function MdfeSefazInfSegToJSON(value?: MdfeSefazInfSeg | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
