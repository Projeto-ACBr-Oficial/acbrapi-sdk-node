 ...
 * @export
 * @interface NfeSefazGPagAntecipado
 */
export interface NfeSefazGPagAntecipado {
    /**
     * Chave de acesso da NF-e de antecipação de pagamento.
     * @type {Array<string>}
     * @memberof NfeSefazGPagAntecipado
     */
    refNFe: Array<string>;
}

/**
 * Check if a given object implements the NfeSefazGPagAntecipado interface.
 */
export function instanceOfNfeSefazGPagAntecipado(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "refNFe" in value;

    return isInstance;
}

export function NfeSefazGPagAntecipadoFromJSON(json: any): NfeSefazGPagAntecipado {
    return NfeSefazGPagAntecipadoFromJSONTyped(json, false);
}

export function NfeSefazGPagAntecipadoFromJSONTyped(json: any, ignoreDiscriminator: boolean): NfeSefazGPagAntecipado {
...
export function NfeSefazGPagAntecipadoToJSON(value?: NfeSefazGPagAntecipado | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
