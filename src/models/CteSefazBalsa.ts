 ...
 * @export
 * @interface CteSefazBalsa
 */
export interface CteSefazBalsa {
    /**
     * Identificador da Balsa.
     * @type {string}
     * @memberof CteSefazBalsa
     */
    xBalsa: string | null;
}

/**
 * Check if a given object implements the CteSefazBalsa interface.
 */
export function instanceOfCteSefazBalsa(value: object): boolean {
    let isInstance = true;
...
export function CteSefazBalsaFromJSON(json: any): CteSefazBalsa {
    return CteSefazBalsaFromJSONTyped(json, false);
}

export function CteSefazBalsaFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazBalsa {
...
export function CteSefazBalsaToJSON(value?: CteSefazBalsa | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
