...
export interface InfoItemPed {
     ...
     * @type {Array<string>}
     * @memberof InfoItemPed
     */
    xItemPed: Array<string>;
}

/**
 * Check if a given object implements the InfoItemPed interface.
 */
export function instanceOfInfoItemPed(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "xItemPed" in value;

    return isInstance;
}

export function InfoItemPedFromJSON(json: any): InfoItemPed {
    return InfoItemPedFromJSONTyped(json, false);
}

export function InfoItemPedFromJSONTyped(json: any, ignoreDiscriminator: boolean): InfoItemPed {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'xItemPed': json['xItemPed'],
    };
}

export function InfoItemPedToJSON(value?: InfoItemPed | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
