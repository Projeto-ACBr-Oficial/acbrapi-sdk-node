...
/**
 * Check if a given object implements the CteSefazICMSSN interface.
 */
export function instanceOfCteSefazICMSSN(value: object): boolean {
    let isInstance = true;
...
export function CteSefazICMSSNFromJSON(json: any): CteSefazICMSSN {
    return CteSefazICMSSNFromJSONTyped(json, false);
}

export function CteSefazICMSSNFromJSONTyped(json: any, ignoreDiscriminator: boolean): CteSefazICMSSN {
...
export function CteSefazICMSSNToJSON(value?: CteSefazICMSSN | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
